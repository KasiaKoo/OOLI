...
scan.set_save_directory("C:\\Users\\reddragon\\Documents\\280423", "Scan_FROG_BBO100um_long_c6p85_clockwiseongrating")
...
time.sleep(5)
print(c_stage.get_position())
scan.add_axis(frog_stage, np.arange(15.501-0.2,15.501+0.25, 0.004))
