...
frog_stage = Stage("MirrorDelay").initiate()

scan = ScanGenerator()
scan.set_detector(spectrometer)
scan.set_save_directory("C:\\Users\\CLI\\OneDrive - Imperial College London (1)\\PhD\\09 Lab\Rose\\Autocorrelation\\23.10.23", "Setup_ww_lowexposure")
