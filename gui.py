...
class Camera_App:
    ...
    def make_horizontal_graph(self):
        graph = self.video.make_graph(self.preview, axis=0, dpi=self.monitor_dpi, graph_height=self.reference_graph_height)
    ...
    def make_vertical_graph(self):
        graph = self.video.make_graph(self.preview, axis=1, dpi=self.monitor_dpi, graph_height=self.reference_graph_height)
